...
<div class="container">
	...
	<div class="form-group">
		<label for="username">이름:</label> <input type="text"
			class="form-control" id="username" placeholder="Enter Name" readonly="readonly"
			name="username">
	</div>
	<div class="form-group">
		<label for="email">이메일:</label> <input type="email"
			class="form-control" id="email" placeholder="Enter Email" readonly="readonly"
	...
	<button class="btn btn-secondary" id="btnUpdate">회원정보변경</button>
