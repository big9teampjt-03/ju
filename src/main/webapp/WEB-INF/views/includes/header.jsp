...
<div class = "container">
  ...
  <sec:authorize access="isAnonymous()">
    ...
    <li class="nav-item"><a class="nav-link"  href="/joinForm">Sign Up</a></li>
    </sec:authorize>
  <sec:authorize access="isAuthenticated()"> <!-- 일반 회원, 권한명 바꿔야 함 -->
    ...
    <li class="nav-item"><a class="nav-link" href="/logout">Log Out(<sec:authentication property="principal.doc.username" />)</a></li>
    ...
    <li class="nav-item"><a class="nav-link" href="/logout">Log Out(<sec:authentication property="principal.ad.username" />)</a></li>
